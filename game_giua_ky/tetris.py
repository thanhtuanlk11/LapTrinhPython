...
grid = [0] * columns * rows
#print(grid)
speed, score, level, temp, you= 1000, 0, 1, 0,''
# load hình 
picture = [] # 
for n in range(8):
...
#nhạc
sound=pg.mixer.Sound('no6.wav') #nhạc  
...
while status:
  ...
  textsurface = pg.font.SysFont('consolas', 60).render(f' {you}', False, (255, 255, 255))
  screen.blit(textsurface, (width // 5 - textsurface.get_width() // 2,355))
